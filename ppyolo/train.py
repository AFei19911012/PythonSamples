...
def parse_args():
    ...
    parser.add_argument("-c", "--config", type=str, default='configs/yolov3/yolov3_mobilenet_v1_roadsign.yml', help="configuration file to use")
    ...
    parser.add_argument("--enable_ce", type=bool, default=False, help="If set True, enable continuous evaluation job." "This flag is only used for "
                                                                      "internal test.")
