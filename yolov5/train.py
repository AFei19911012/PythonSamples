...
def parse_opt():
    ...
    parser.add_argument('--cfg', type=str, default='models/my_yolo.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/my_yolo.yaml', help='dataset.yaml path')
