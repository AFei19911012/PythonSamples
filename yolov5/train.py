...
def parse_opt():
    ...
    parser.add_argument('--cfg', type=str, default='models/my_rubbish.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/my_rubbish.yaml', help='dataset.yaml path')
