# -*- coding: utf-8 -*-
"""
 Created on 2021/7/6 23:13
 Filename   : ex_linear_quadratic_discriminant_analysis.py
 Author     : Taosy.W
...
def plot_lda_qda():
    ...
    def plot_ellipse(splot, mean, cov, color):
        ...
        ell = mpl.patches.Ellipse(mean, 2 * v[0] ** 0.5, 2 * v[1] ** 0.5, 180 + angle, facecolor=color, edgecolor='black', linewidth=2)
